...
- Follow existing code style. For Go, run `gofmt` and `go vet` before submitting.
- For frontend changes, keep files self-contained and test in `go run .`.
- Add tests where appropriate.

If you'd like help preparing a first PR, open an issue and I'll assist.